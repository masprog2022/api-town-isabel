...
import com.masprogtechs.apitownisabel.dtos.UserLoginDto;
import com.masprogtechs.apitownisabel.dtos.UserResponseDto;
import com.masprogtechs.apitownisabel.jwt.JwtToken;
import com.masprogtechs.apitownisabel.jwt.JwtUserDetailsService;
...
@Tag(name = "Autenticação", description = "Endpoint para proceder com autenticação" )
@Slf4j
...
public class AuthController {
    ...
    @Operation(summary = "Autenticar", description = "Recurso para autenticar",
            responses = {
